...
$installRoot = Join-Path $env:LOCALAPPDATA "CodexSocialBridge"
...
Write-Host ""
Write-Host "Codex Social Bridge Windows setup" -ForegroundColor Green
...
try {
  ...
  $shortcutPath = Join-Path $desktop "Codex Social Bridge.lnk"
